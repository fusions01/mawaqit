...
export class Backend implements backendInterface {
    ...
    async getTasbihCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasbihCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async incrementTasbih(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementTasbih();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetTasbih(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetTasbih();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSettings(arg0: string, arg1: boolean, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
